                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="overview" type="text" class="form-control" name="overview"
                                                placeholder="Enter slider overview" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-group-default">
                                            ...
                                            <textarea id="description" class="form-control" name="description" placeholder="Enter slider description" rows="4"></textarea>
                                        </div>
                                    </div>
                                </div>
