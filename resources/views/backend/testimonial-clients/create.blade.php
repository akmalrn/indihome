    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Create New testimonial-clients</h3>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Create New Testimonial Client</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('testimonial-clients.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="name" type="text" class="form-control" name="name"
                                                placeholder="Enter testimonial-clients name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="position" type="text" class="form-control" name="position"
                                                placeholder="Enter testimonial-clients position" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-group-default">
                                            ...
                                            <textarea id="description" class="form-control" name="description" placeholder="Enter testimonial-clients description" rows="4"></textarea>
                                        </div>
                                    </div>
                                </div>
